...
THREEx.ThreePointsLighting	= function(){
	...
	var object3d	= new THREE.DirectionalLight('white', 0.112)
	object3d.position.set(2.6,1,3)
	object3d.name	= 'Back light'
	container.add(object3d)

	var object3d	= new THREE.DirectionalLight('white', 0.167)
	object3d.position.set(-2, -1, 0)
	object3d.name 	= 'Key light'
	container.add(object3d)

	var object3d	= new THREE.DirectionalLight('white', 0.45)
